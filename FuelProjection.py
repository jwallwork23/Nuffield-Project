...
P0 = {0: 7.5e9, 1: 11.4e6, 2: 127e6, 3: 53.3e6, 4: 37.5e6}          # 0th entry corresponds to world population
P_rate = {1: 1.39e-3, 2: 9.35e-3, 3: 1.57e-2, 4: 3.31e-2}

# List initial fuel values and consumption rates:
B0 = {1: 6.08e8, 2: 4.9e9, 3: 1.81e9, 4: 4.61e8, 0: 2.4e13}
C0 = {1: 2.44e7, 2: 5.23e8, 3: 30e9, 4: 3.49e5, 0: 4.7e12}
G0 = {1: 1.71e11, 2: 3.51e11, 3: 3.17e7, 4: 2.41e10, 0: 8.7e12}
O0 = {1: 2.43e7, 2: 3.69e8, 3: 4.53e10, 4: 4.13e8, 0: 1.9e12}
...
K = {1: 1.52e7, 2: 1.69e8, 3: 7.11e7, 4: 5e7, 0: 10e9}  # Carrying capacity of countries and world
